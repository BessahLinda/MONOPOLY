...
class StrategyTest {
    ...
    public void setColorMonopolist(){
        ...
        p.buyLand(s1);p.buyLand(s2);p.buyLand(s3);p.buyLand(s4);p.buyLand(s5);p.buyLand(s6);p.buyLand(s7);p.buyLand(s8);p.buyLand(s9);p.buyLand(s10);p.buyLand(s11);p.buyLand(s12);p.buyLand(s13);p.buyLand(s14);p.buyLand(s15);p.buyLand(s16);
        p.buyLand(s17);p.buyLand(s18);p.buyLand(s19);p.buyLand(s20);p.buyLand(s21);
    ...
    public void testBuyHouse4(){
        ...
        p.buyHouse();
        assertEquals(s9.getNbHouse(), 2);
        assertEquals(s10.getNbHouse(), 2);
        assertEquals(s11.getNbHouse(), 1);

        p.earnMoney(500);
        p.buyHouse();

        assertEquals(s11.getNbHouse(), 2);

        assertEquals(s9.getNbHouse(), 4);
        assertEquals(s10.getNbHouse(), 4);
        assertEquals(s1.getNbHouse(), 0);
        assertEquals(s2.getNbHouse(), 0);

        p.earnMoney(500);
        p.buyHouse();

        assertEquals(s11.getNbHouse(), 4);
